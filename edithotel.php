...
<head><link rel="stylesheet" type="text/css" href="koththuupdate.css"/>
...
<div id="mai">                 <!--main div start-->
 ...
 <div id="contl">   <!--cont div left start-->  
            ...
            <div class="tpcon">
            	<form action="renewhotel.php" method="post">
                	<table>
                    <tr>
                        	<td>
                            	<p>Hotel ID</p>
                            ...
                            <td>
                            	<input type="text" name="hid" id="kid" class="kup" value="<?php echo $id;?>" readonly="readonly"/>
                            </td>
                        </tr>
                    	<tr>
                        	<td>
                            ...
                            <td>
                            	<input type="text" name="hname" id="kname" class="kup" value="<?php echo $hname;?>"/>
                            </td>
                        </tr>
                          ...
                          <tr>
                            ...
                            <td>
                            	<input type="number" name="hmob" id="Lprice" class="kup" value="<?php echo $htel;?>"/>
                            </td>
                        </tr>
