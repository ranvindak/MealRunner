...
<br>
 ...
 <div id="contl">   <!--cont div left start-->  
            <h3 id="topp">Dessert List For You</h3>
            <div>
	<?php
	include"connect.php";
	...
	<tr>
		...
		while($row=mysqli_fetch_assoc($result))
		{
			 ...
			 echo'<tr>'.'<td>'.$row['Dname'].'</td>'.'<td>'.$row['Dprice'].'</td>'.'<td><button onclick="location.href='."'dessertorder.php ? Id=".$row['Did']."'".'">Order Now</button></td>'.'<tr>';
