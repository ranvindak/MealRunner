...
?>  
 ...
 <div id="contl">   <!--cont div left start-->  
   <div class="tpcon">
   <form action="validateadminhotel.php" method ="POST" class = "form1" >
   
   <label>Hotel Name</label>
   <br>
   <input type="text" id="hname" name="hname" class="typp"/>
    <br><br>
  
   <label>Hotel contact number</label>
   <br>
  <input type="text" id="contact" name="contact"  class="typp"/>
   <br><br>
