<?php
	...
	if(mysqli_num_rows($result)>0)
	{
		while($row=mysqli_fetch_assoc($result))
		{
			$kid=$row['K_id'];
			$kname=$row['K_name'];
			$klprice=$row['K_Lprice'];
			$ksprice=$row['K_Sprice'];
...
<div id="mai">                 <!--main div start-->
 ...
 <div id="contl">   <!--cont div left start-->  
            ...
            <div class="tpcon">
            	<form action="renewkoththu.php" method="post" class="reg">
                	<table>
                    <tr>
                        	<td>
                            	<p>Koththu ID</p>
                            ...
                            <td>
                            	<input type="text" name="kid" id="kid" class="kup" value="<?php echo $kid;?>" readonly="readonly"/>
                            </td>
                        </tr>
                    	<tr>
                        	<td>
                            ...
                            <td>
                            	<input type="text" name="kname" id="kname" class="kup" value="<?php echo $kname;?>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="number" name="Lprice" id="Lprice" class="kup" value="<?php echo $klprice;?>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="number" name="Sprice" id="Sprice" class="kup" value="<?php echo $ksprice;?>"/>
                            </td>
                        </tr>
                    </table>
