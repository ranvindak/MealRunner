...
<title>Admin | dessert update</title>
...
?>  
 ...
 <div id="contl">   <!--cont div left start-->  
            ...
            <div class="tpcon">
            	<form action="validatedessertupdate.php" method="post">
                	<table>
                    	<tr>
                        	<td>
                            	<p>Enter Dessert Name</p>
                            </td>
                            <td>
                            	<input type="text" name="dname" id="bname" class="kup"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="number" name="dprice" id="bprice" class="kup"/>
                            </td>
                        </tr>
