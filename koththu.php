...
<br>
	...
	<tr>
		...
		while($row=mysqli_fetch_assoc($result))
		{
			 ...
			 echo'<tr>'.'<td>'.$row['K_id'].'</td>'.'<td>'.$row['K_name'].'</td>'.'<td>'.$row['K_Lprice'].'</td><td>'.$row['K_Sprice'].'</td>'.'<td>'.'<button onclick="location.href='."'editkoththu.php ? Id=".$row['K_id']."'".'">Edit</button>'.'</td>'.'</tr>';
