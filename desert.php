...
<br>
	...
	<tr>
		...
		while($row=mysqli_fetch_assoc($result))
		{
			 ...
			 echo'<tr>'.'<td>'.$row['Did'].'</td>'.'<td>'.$row['Dname'].'</td>'.'<td>'.$row['Dprice'].'</td>'.'<td>'.'<button onclick="location.href='."'editdessert.php ? Id=".$row['Did']."'".'">Edit</button>'.'</td>'.'<tr>';
