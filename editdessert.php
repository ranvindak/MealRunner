<?php
	...
	$sql="SELECT * FROM dessert WHERE Did='$id'";
...
<div id="mai">                 <!--main div start-->
 ...
 <div id="contl">   <!--cont div left start-->  
            ...
            <div class="tpcon">
            	<form action="renewdessert.php" method="post">
                	<table>
                    <tr>
                        	<td>
                            	<p>Dessert ID</p>
                    	...
                    	<tr>
                            ...
                            <td>
                            	<input type="text" name="kname" id="kname" class="kup" value="<?php echo $Dname;?>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="number" name="Lprice" id="Lprice" class="kup" value="<?php echo $Dprice;?>"/>
                            </td>
                        </tr>
