...
?>  
 ...
 <div id="contl">   <!--cont div left start-->  
            ...
            <div class="tpcon">
            	<form action="validatefriedrice.php" method="post">
                	<table>
                    	<tr>
                        	<td>
                            	<p>Enter Rice Name</p>
                            ...
                            <td>
                            	<input type="text" name="rname" id="rname" class="kup"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="number" name="Lprice" id="Lprice" class="kup"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="number" name="Sprice" id="Sprice" class="kup"/>
                            </td>
                        </tr>
                    </table>
