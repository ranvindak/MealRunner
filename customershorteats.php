...
<title>Customer shorteats</title>
...
<br>
 ...
 <div id="contl">   <!--cont div left start-->  
            <h3 id="topp">Short eats List For You</h3>
            <div>
  <?php
	include"connect.php";
	...
	<tr>
		...
		while($row=mysqli_fetch_assoc($result))
		{
			 ...
			 echo'<tr>'.'<td>'.$row['se_name'].'</td>'.'<td>'.$row['se_price'].
			 '</td>'.
			  '<td><button class="btnl" onclick="location.href='."'shorteatsorder.php ? Id=".$row['seID']."'".'">Order Now</button></td>'.'</tr>';
