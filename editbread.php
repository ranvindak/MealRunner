<?php
	...
	$sql="SELECT * FROM bread WHERE B_ID='$id'";
...
<div id="mai">                 <!--main div start-->
 ...
 <div id="contl">   <!--cont div left start-->  
            ...
            <div class="tpcon">
            	<form action="renewbread.php" method="post">
                	<table>
                    <tr>
                        	<td>
                            	<p>Bread ID</p>
                    	...
                    	<tr>
                            ...
                            <td>
                            	<input type="text" name="kname" id="kname" class="kup" value="<?php echo $Bname;?>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="number" name="Lprice" id="Lprice" class="kup" value="<?php echo $Bprice;?>"/>
                            </td>
                        </tr>
