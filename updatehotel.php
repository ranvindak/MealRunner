...
<br>
	...
	<tr>
		...
		<td><b>Hotel Contact Number</b></td>
		<td><b>Edit</b></td>
		...
		while($row=mysqli_fetch_assoc($result))
		{
			 ...
			 echo'<tr>'.'<td>'.$row['Hotel_ID'].'</td>'.'<td>'.$row['Hotel_name'].'</td>'.'<td>'.$row['Tele'].'</td>'.
			 '<td>'.'<button onclick="location.href='."'edithotel.php ? Id=".$row['Hotel_ID']."'".'">Edit</button>'.'</td>'.'<tr>';
